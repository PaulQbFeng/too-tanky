...
damage1 = ahri.damage_physical_attack(annie)
damage2 = annie.damage_physical_attack(ahri)
damage3 = jax.damage_physical_attack(irelia)
damage4 = irelia.damage_physical_attack(jax)
