...
def test_auto_attack_black_cleaver():
    ...
    assert round(ahri.total_armor, 3) == round(orig_armor * 0.95, 3)
    caitlyn.auto_attack(ahri)
    assert round(ahri.total_armor, 3) == round(orig_armor * 0.9, 3)
    caitlyn.auto_attack(ahri)
    assert round(ahri.total_armor, 3) == round(orig_armor * 0.85, 3)
    caitlyn.auto_attack(ahri)
    assert round(ahri.total_armor, 3) == round(orig_armor * 0.8, 3)
    caitlyn.auto_attack(ahri)
    assert round(ahri.total_armor, 3) == round(orig_armor * 0.75, 3)
    caitlyn.auto_attack(ahri)
    assert round(ahri.total_armor, 3) == round(orig_armor * 0.7, 3)
    caitlyn.auto_attack(ahri)
    assert round(ahri.total_armor, 3) == round(orig_armor * 0.7, 3)
    caitlyn.auto_attack(ahri)
    assert round(ahri.total_armor, 3) == round(orig_armor * 0.7, 3)
